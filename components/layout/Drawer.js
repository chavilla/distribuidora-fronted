...
import { makeStyles, Drawer, Divider, Typography, ThemeProvider, Container } from '@material-ui/core';
    ...
    return ( 
        ...
        >
            <Container className={classes.toolbar}   className={classes.fondo}>
                <Typography variant='h4' color="primary" align='center' className={classes.company}>Chaviweb</Typography>
            </Container>
